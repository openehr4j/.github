...
This project provides a collection of Maven packages with Java interface declarations for the classes defined in the [openEHR specifications](https://specifications.openehr.org/).
